...
services. It starts an infinite loop (use CLI), and if any of available
devices or services are found, the proper callback function will be
invoked.

**示例 \#1 Search for all UPnP devices and services.**
...
**示例 \#1 Implementing light server**
...
**示例 \#2 Implementing light client**
