...
范围操作以 ASCII 整理排序。它们可以用于为字符指定数值，比如
...
如果一个选项在子组中设置，产生的影响是不同的。这是 perl 5.005
...
在 PHP 5.2.2之后， *\\g* 转义序列可以用于子模式的绝对和相对引用。
...
>
> *u* (*PCRE\_UTF8*)  
> <span class="simpara"> 此修正符打开一个与 perl 不兼容的附加功能。
