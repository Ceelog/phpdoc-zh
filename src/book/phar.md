...
> **Note**:
>
> 此方法已经从 phar 扩展 2.0.0以上版本中删除。可使用 <span
> class="function">Phar::compress</span>，<span
> class="function">Phar::decompress</span>，<span
> class="function">Phar::compressFiles</span> 和 <span
> class="function">Phar::decompressFiles</span>替代。
...
**示例 \#1 A <span class="function">Phar::compressAllFilesBZIP2</span>
example**
...
**示例 \#1 A <span class="function">Phar::compressAllFilesGZ</span>
example**
...
<span class="modifier">public</span> <span class="type">bool</span>
<span class="methodname">Phar::uncompressAllFiles</span> ( <span
class="methodparam">void</span> )
...
already compressed using gzip compression, the
<a href="/ref/zlib.html" class="link">zlib</a> extension must be enabled
in order to decompress the files, and any files compressed using bzip2
compression require the <a href="/ref/bzip2.html" class="link">bzip2</a>
extension to decompress the files. As with all functionality that
modifies the contents of a phar, the
<a href="/phar/setup.html#" class="link">phar.readonly</a> INI variable
must be off in order to succeed.
...
<a href="/phar/setup.html#" class="link">phar.readonly</a> INI variable
is on, the <a href="/ref/bzip2.html" class="link">bzip2</a> extension is
not enabled and any files are compressed using bzip2 compression, or if
any files are compressed using gzip compression and the
<a href="/ref/zlib.html" class="link">zlib</a> extension is not enabled.

### 范例

**示例 \#1 A <span class="function">Phar::uncompressAllFiles</span>
example**
...
<span class="modifier">public</span> <span class="type">bool</span>
<span class="methodname">isCompressedBZIP2</span> ( <span
class="methodparam">void</span> )

<span class="modifier">public</span> <span class="type">bool</span>
<span class="methodname">isCompressedGZ</span> ( <span
class="methodparam">void</span> )

<span class="modifier">public</span> <span class="type">bool</span>
<span class="methodname">setCompressedBZIP2</span> ( <span
class="methodparam">void</span> )

<span class="modifier">public</span> <span class="type">bool</span>
<span class="methodname">setCompressedGZ</span> ( <span
class="methodparam">void</span> )
...
<span class="modifier">public</span> <span class="type">bool</span>
<span class="methodname">setUncompressed</span> ( <span
class="methodparam">void</span> )
...
<span class="modifier">public</span> <span class="type">bool</span>
<span class="methodname">PharFileInfo::isCompressedBZIP2</span> ( <span
class="methodparam">void</span> )

> **Note**:
>
> 此方法已经从 phar 扩展 2.0.0以上版本中删除。可使用 <span
> class="function">PharFileInfo::isCompressed</span>，<span
> class="function">PharFileInfo::decompress</span> 和 <span
> class="function">PharFileInfo::compress</span>替代。
...
**`TRUE`** if the file is compressed within the Phar archive using
Bzip2, **`FALSE`** if not.

### 范例

**示例 \#1 A <span
class="function">PharFileInfo::isCompressedBZIP2</span> example**
...
<span class="modifier">public</span> <span class="type">bool</span>
<span class="methodname">PharFileInfo::isCompressedGZ</span> ( <span
class="methodparam">void</span> )
...
**`TRUE`** if the file is compressed within the Phar archive using Gzip,
**`FALSE`** if not.

### 范例

**示例 \#1 A <span class="function">PharFileInfo::isCompressedGZ</span>
example**
...
<span class="modifier">public</span> <span class="type">bool</span>
<span class="methodname">PharFileInfo::setCompressedBZIP2</span> ( <span
class="methodparam">void</span> )
...
compression. The <a href="/ref/bzip2.html" class="link">bzip2</a>
extension must be enabled to take advantage of this feature. In
addition, if the file is already compressed using gzip compression, the
<a href="/ref/zlib.html" class="link">zlib</a> extension must be enabled
in order to decompress the file. As with all functionality that modifies
the contents of a phar, the
<a href="/phar/setup.html#" class="link">phar.readonly</a> INI variable
must be off in order to succeed.
...
Throws <span class="classname">BadMethodCallException</span> if the
<a href="/phar/setup.html#" class="link">phar.readonly</a> INI variable
is on, or if the <a href="/ref/bzip2.html" class="link">bzip2</a>
extension is not available.

### 范例

**示例 \#1 A <span
class="function">PharFileInfo::setCompressedBZIP2</span> example**
...
<span class="modifier">public</span> <span class="type">bool</span>
<span class="methodname">PharFileInfo::setCompressedGZ</span> ( <span
class="methodparam">void</span> )
...
compression. The <a href="/ref/zlib.html" class="link">zlib</a>
extension must be enabled to take advantage of this feature. In
addition, if the file is already compressed using bzip2 compression, the
<a href="/ref/bzip2.html" class="link">bzip2</a> extension must be
enabled in order to decompress the file. As with all functionality that
modifies the contents of a phar, the
<a href="/phar/setup.html#" class="link">phar.readonly</a> INI variable
must be off in order to succeed.
...
Throws <span class="classname">BadMethodCallException</span> if the
<a href="/phar/setup.html#" class="link">phar.readonly</a> INI variable
is on, or if the <a href="/ref/zlib.html" class="link">zlib</a>
extension is not available.

### 范例

**示例 \#1 A <span class="function">PharFileInfo::setCompressedGZ</span>
example**
...
<span class="modifier">public</span> <span class="type">bool</span>
<span class="methodname">PharFileInfo::setUncompressed</span> ( <span
class="methodparam">void</span> )
...
**示例 \#1 A <span class="function">PharFileInfo::setUncompressed</span>
example**
