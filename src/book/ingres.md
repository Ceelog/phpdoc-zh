...
`ingres.allow_persistent` <span class="type">boolean</span>  
Specifies whether to allow
<a href="/features/persistent-connections.html" class="link">persistent connections</a>
to Ingres

`ingres.array_index_start` <span class="type">integer</span>  
...
`ingres.auto` <span class="type">boolean</span>  
...
`ingres.blob_segment_length` <span class="type">integer</span>  
Specifies the amount of memory to use when reading BLOB data, in bytes

`ingres.cursor_mode` <span class="type">integer</span>  
...
`ingres.describe` <span class="type">boolean</span>  
...
`ingres.fetch_buffer_size` <span class="type">integer</span>  
...
`ingres.max_links` <span class="type">integer</span>  
...
`ingres.max_persistent` <span class="type">integer</span>  
...
`ingres.reuse_connection` <span class="type">boolean</span>  
Reuses an existing active connection if connecting to the same database
with the same user name

`ingres.scrollable` <span class="type">boolean</span>  
...
`ingres.trace` <span class="type">boolean</span>  
Enables simple tracing using **`E_NOTICE`** messages

`ingres.trace_connect` <span class="type">boolean</span>  
...
`ingres.utf8` <span class="type">boolean</span>  
...
**`INGRES_BOTH`** (<span class="type">integer</span>)  
...
**`INGRES_API_VERSION`** (<span class="type">integer</span>)  
...
**`INGRES_CURSOR_READONLY`** (<span class="type">integer</span>)  
...
**`INGRES_CURSOR_UPDATE`** (<span class="type">integer</span>)  
...
**`INGRES_DATE_MULTINATIONAL`** (<span class="type">integer</span>)  
...
**`INGRES_DATE_MULTINATIONAL4`** (<span class="type">integer</span>)  
<span class="simpara"> Equivalent to the II\_DATE\_FORMAT setting of
...
**`INGRES_DATE_FINNISH`** (<span class="type">integer</span>)  
<span class="simpara"> Equivalent to the II\_DATE\_FORMAT setting of
...
**`INGRES_DATE_ISO`** (<span class="type">integer</span>)  
<span class="simpara"> Equivalent to the II\_DATE\_FORMAT setting of
...
**`INGRES_DATE_ISO4`** (<span class="type">integer</span>)  
<span class="simpara"> Equivalent to the II\_DATE\_FORMAT setting of
...
**`INGRES_DATE_GERMAN`** (<span class="type">integer</span>)  
<span class="simpara"> Equivalent to the II\_DATE\_FORMAT setting of
...
**`INGRES_DATE_MDY`** (<span class="type">integer</span>)  
<span class="simpara"> Equivalent to the II\_DATE\_FORMAT setting of
...
**`INGRES_DATE_DMY`** (<span class="type">integer</span>)  
<span class="simpara"> Equivalent to the II\_DATE\_FORMAT setting of
...
**`INGRES_DATE_YMD`** (<span class="type">integer</span>)  
<span class="simpara"> Equivalent to the II\_DATE\_FORMAT setting of
...
**`INGRES_MONEY_LEADING`** (<span class="type">integer</span>)  
...
**`INGRES_MONEY_TRAILING`** (<span class="type">integer</span>)  
<span class="simpara"> Specifies the currency character that should be
...
**`INGRES_STRUCTURE_BTREE`** (<span class="type">integer</span>)  
...
**`INGRES_STRUCTURE_CBTREE`** (<span class="type">integer</span>)  
<span class="simpara"> Specifies the default table or index structure to
...
**`INGRES_STRUCTURE_HASH`** (<span class="type">integer</span>)  
<span class="simpara"> Specifies the default table or index structure to
...
**`INGRES_STRUCTURE_CHASH`** (<span class="type">integer</span>)  
<span class="simpara"> Specifies the default table or index structure to
...
**`INGRES_STRUCTURE_HEAP`** (<span class="type">integer</span>)  
...
**`INGRES_STRUCTURE_CHEAP`** (<span class="type">integer</span>)  
...
**`INGRES_STRUCTURE_ISAM`** (<span class="type">integer</span>)  
<span class="simpara"> Specifies the default table or index structure to
...
**`INGRES_STRUCTURE_CISAM`** (<span class="type">integer</span>)  
<span class="simpara"> Specifies the default table or index structure to
...
Returns an <span class="type">integer</span> if there is a return value
